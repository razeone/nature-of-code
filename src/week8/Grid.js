/**
 * @class Grid
 * @description Conway's Game of Life grid on a toroidal world.
 *              Tracks cell ages so the renderer can color stable patterns
...
export default class Grid {
  ...
  /** Index with toroidal wrap — the world loops on the edges. */
  idx(x, y) {
